...
export default {
    ...
    methods:{
        ...mapActions('ContactBook',['postContactBook']),
        onSubmit(){
            this.$store.dispatch('ContactBook/postContactBook',{

                name:this.contactbook.name,
                city:this.contactbook.city,
                phone:this.contactbook.phone,
                category_id:this.contactbook.category_id,
                observations:this.contactbook.observations,
            })
